...
#   Efficient multi-scale convolutional attention decoding (EMSCA)
class EMSCA(nn.Module):
    def __init__(self, channels=[512,320,128,64], kernel_sizes=[1,3,5], expansion_factor=6, dw_parallel=True, add=True, kernel_scale=3, activation='relu6'):
        super(EMSCA,self).__init__()
        ...
        self.lgag3 = LGAG(F_g=channels[1], F_l=channels[1], F_int=channels[1]//2, kernel_size=kernel_scale, groups=channels[1]//2)
        ...
        self.lgag2 = LGAG(F_g=channels[2], F_l=channels[2], F_int=channels[2]//2, kernel_size=kernel_scale, groups=channels[2]//2)
        ...
        self.lgag1 = LGAG(F_g=channels[3], F_l=channels[3], F_int=int(channels[3]/2), kernel_size=kernel_scale, groups=int(channels[3]/2))
